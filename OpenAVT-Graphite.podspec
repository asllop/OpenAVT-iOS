#
# Be sure to run `pod lib lint OpenAVT-Graphite.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
  Open Audio-Video Telemetry, Graphite backend. It contains a backend for the Graphite metrics collector, it depends on OpenAVT-Core.
                       DESC
  ...
  s.source_files = 'OpenAVT-Graphite/Classes/**/*'
  
  # s.resource_bundles = {
  #   'OpenAVT-Graphite' => ['OpenAVT-Graphite/Assets/*.png']
  # }
